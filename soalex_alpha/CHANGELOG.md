...
Headline: **Soalex sagt jetzt, wenn dein Akku nicht mehr antwortet.** Das war das Muster fast aller Einsendungen dieser Runde — der Akku stand still oder tat das Falsche, die Anzeige blieb ruhig, und gemerkt habt ihr es am Stromzähler. Dazu drei Einrichtungs-Fallen, die still falsche Werte erzeugt haben, und ein Diagnose-Export, der endlich zuverlässig startet. Jeder Punkt unten geht auf eines eurer Diagnose-Pakete zurück.

### Behoben — wenn der Akku nicht tat, was er sollte

- **Stiller Ausfall: Soalex zeigte den Befehl statt der Messung.** Nach einem IP-Wechsel war ein Akku fast sechzehn Stunden nicht erreichbar — Ladestand seit zwölf Stunden eingefroren, Leistungssensor tot. Soalex befahl nachts entladen und morgens laden, beides verpuffte, und die Anzeige sah normal aus (in dieser einen Nacht: 3,75 kWh aus dem Netz und 31 kWh eingespeist statt geladen). Steht der Ladestand jetzt still, obwohl Soalex den Akku nachweislich fährt, sagt es das nach drei Minuten im Klartext — „Dein Akku antwortet nicht" — und verteilt die Leistung so lange auf die übrigen Akkus, statt sie weiter an einen zu schicken, bei dem nichts ankommt.
- **Große Akkus standen nachts in einer Sperre.** Der Plausibilitäts-Check rechnete mit angenommenen 5,1 kWh Kapazität. Bei einem 14,7-kWh-Speicher passte damit alle knapp vier Minuten etwas „nicht zusammen"; in einer gemessenen Nacht stand der Akku über neunzig Prozent der Zeit blockiert. Soalex rechnet jetzt nur noch mit einer Kapazität, die es wirklich kennt — und lässt den Check ganz weg, wenn es keine kennt.
- **Falscher Alarm „Akku liefert nicht" bei einseitigen Leistungssensoren.** Misst euer Sensor nur eine Richtung (bei manchen Ladegeräten und Zendure-Vorlagen der Fall), zählte Soalex die Messwerte am Befehl statt am Vorzeichen — und schützte dadurch die falsche Richtung. Ergebnis waren Fehlalarme und Schutz-Pausen auf gesunden Anlagen. Die Erkennung braucht jetzt echten Beleg in beiden Richtungen und nimmt ihn zurück, wenn er sich nicht bestätigt.
- **Lade- und Entladegrenze sind jetzt getrennt.** Wer für das Laden mehr als 800 W eingestellt hatte, konnte seine Einspeisegrenze beim Entladen nicht mehr halten (in einem Fall 49 Entladungen über der Grenze). Du kannst beide Richtungen jetzt getrennt begrenzen; trägst du nichts ein, gilt weiter deine „Maximum-Leistung" für beides. Zusätzlich behoben: eine Entladung wurde intern gegen die *Lade*grenze geprüft und konnte daran unsichtbar scheitern.
- **Geräte, die nach einem Befehl kurz nicht mehr annehmen.** Manche Akkus — vor allem über Modbus und bei Anker — weisen eine Anpassung ab, wenn die vorige noch keine halbe Minute her ist. Das galt bisher als Fehler und löste Schutz-Pausen aus. Soalex lernt jetzt die tatsächliche Wartezeit deines Geräts und behandelt sie als das, was sie ist: kurz warten. Ein Stopp geht davon unberührt sofort raus.
- **Mehrere Akkus: fairere Reihenfolge.** Ein Akku ohne eigene Messwerte übernimmt jetzt die gemessene Reaktionszeit seines schnellsten baugleichen Geschwisters. Vorher konnte er hinten einsortiert werden, kaum Anpassungen bekommen — und damit nie die Messwerte sammeln, aus denen er nach vorne gekommen wäre.
- **Nach einem Tausch des Ladestand-Sensors lief der Akku still ohne Ladestand weiter.** Die neue Sensor-Zeile wurde nicht in Betrieb genommen und vom Akku-Pool ignoriert. Behoben, auch rückwirkend beim Start für bestehende Installationen.
- **Akku-Kachel zeigte die falsche Richtung.** In längeren Ruhephasen stand dort „lädt" mit positivem Wert, obwohl der Akku entladen sollte.

### Behoben — Einrichtung

- **Der Smart Meter ließ sich als Akku-Leistungssensor eintragen.** Der Klassiker dieser Runde: einmal verwechselt, und Soalex misst den ganzen Haushalt statt des Akkus — in einem Setup 4 360 falsche „liefert nicht"-Meldungen und 331 falsche „Eigenmodus"-Meldungen. Das wird jetzt abgelehnt, und der automatische Vorschlag schließt deinen Zähler aus.
- **Freigabe-Schalter, der zu einem fremden Gerät gehörte.** Stand im Freigabe-Feld versehentlich eine Auswahl deiner Wallbox oder deines Wechselrichters (EVCC, SolakonONE „Modus überschreiben"), hat Soalex sie bei **jeder** Anpassung mitgeschaltet — in einem Fall wurde so bei jedem Schreibvorgang der Wallbox-Mindeststrom auf 1 A und einphasig gestellt. Soalex erkennt das jetzt, sagt es dir und leert das Feld auf einen Klick — in der Einrichtung wie in Einstellungen → Anlage.
- **Funktionstest bricht nicht mehr mit einem rohen Fehlertext ab,** wenn dein Gerät zwischen zwei Schritten eine Wartezeit verlangt: Soalex wartet sie ab und versucht es einmal erneut. Scheitert es trotzdem, steht da ein Satz statt einer Fehlermeldung aus dem Innenleben.
- **Funktionstest sagt dir, wenn dein Gerät den Soll-Wert selbst zurücksetzt** — das ist der häufigste Grund dafür, dass ein technisch korrekt eingerichtetes Gerät trotzdem nicht folgt (Hersteller-App, HEMS oder ein interner Modus regeln dagegen).
- **Anker Solarbank:** Die Einrichtung weist jetzt darauf hin, dass der Benutzermodus am Gerät auf „Benutzerdefiniert" stehen muss — ohne ihn existieren die Steuer-Entities gar nicht.
- **Nach einem reinen Sensor-Tausch** bietet Soalex den Funktionstest an, statt ungetestet weiterzulaufen („Ohne Test weiter" bleibt möglich).

### Verbessert — Diagnose und Anzeige

- **Der Diagnose-Export startet sofort.** Bisher lief die ganze Vorbereitung, bevor der Browser das erste Byte sah — auf manchen Systemen minutenlang, weshalb der Download mit „Netzwerkfehler" gar nicht erst anlief. Dazu: Die Datei ist rund achtmal kleiner (aus 53 MB werden 6), sie wird am Ende auf Vollständigkeit geprüft, und wenn der Download in der Companion-App hängen bleibt, gibt es einen „Direkt im Browser laden"-Fallback.
- **Hinweis „Seite neu laden" bei einer neuen Version.** Nach einem Update zeigte der Browser teils stundenlang die alte Oberfläche — inklusive fehlender neuer Funktionen, die dann als „Update hat nicht geklappt" ankamen. ⚠️ Dieser Hinweis kann bei *diesem* Update noch nicht greifen, weil die zwischengespeicherte Seite von 0.1.185 ihn noch nicht kennt: Bitte nach dem Update einmal hart neu laden (Strg+F5, am Handy die Seite neu aufbauen). Ab dem nächsten Update meldet es sich von selbst.
- **Die Status-Helfer heißen jetzt „(nur Anzeige)".** Sie sehen aus wie Schalter, sind aber reine Anzeige — eine Automation, die darüber auf „pausiert" stellte, hat Soalex nicht angehalten, während es weiter regelte. Wie du Soalex wirklich pausierst, steht jetzt in der Dokumentation.

## 0.1.185 — 2026-09-18

- fix(akku): Vorzeichen-Verdacht braucht Evidenz, PV-Deckung ist keine Nicht-Lieferung
- fix(diagnose): Diag-Export startet sofort und haengt nie mehr (BUG-0100)
- fix(8.25): Wallbox-Entladesperre haelt keine Ladung gegen Netzbezug fest (BUG-0099)
- fix(review): Nacht-Gate-Gleichheitsfall, Merit-θ-Fallback, Vorzeichen-Hinweise entkoppelt
- docs(review): Gesamt-Review auf den Stand 12.09. fortgeschrieben
- fix(beta-welle): BUG-0081/0093/0094/0096/0005 — Nacht-Gate-Boden, Vorzeichen-Vorschlag, Merit-θ, Schreib-Sparen
- docs(review): Gesamt-Review aller Epics 2026-09-10 — Synthese + 16 Einzelberichte
- fix(wizard): OverflowError im Live-Echo-Parser
- perf(loops): Verbraucher-Tick ohne DB-Verbindung, Lade-Berater still ohne Preisquelle
- fix(ui): Euro-Erklärung nach BUG-0089 — nur an überwiegenden Lade-Tagen
- fix(ui): Klartext für fünf Backend-Reasons ohne Mapping
- fix(settings): BUG-0093 — Vorzeichen umkehren per Klick, Verdacht folgt dem eingestellten Wert
- fix(diagnose): BUG-0095 — Echo-Nachlauf ist kein Fehler, Helper-Warnungen gedrosselt
- ci(release): Beta-Token vor dem Taggen mit echtem Probe-Push prüfen

## 0.1.184 — 2026-09-11

Dieses Update enthält auch alles aus **0.1.183** — die Version ist wegen einer Panne bei der Auslieferung nie bei euch angekommen. Headline: **ein neuer, deutlich aufgeräumterer Live-Screen** und **Fixes für drei Fälle, in denen der Akku unbemerkt das Falsche tat**: morgens nicht lud, nach einem Stopp weiter aus dem Netz lud oder fälschlich als „im Eigenmodus" galt. Fast jeder Fix unten geht auf einen Diagnose-Export aus der Beta zurück.

### Neu

- **Neuer Live-Screen „Drei Register".** Oben der Zustand in einem Satz, dazu eine Null-Linie, die zeigt, wie nah Soalex deinen Netzbezug an deinem Ziel hält (eine Abweichung ist kein Alarm). In der Mitte „Heute": wie viele Stunden Soalex auf null gehalten hat. Unten deine Anlage als Geräte-Zeilen — „Soll / liefert" erscheint nur, wenn ein Gerät mehr als 30 W vom Sollwert abweicht. Erklärtexte, Diagramm und Verlauf liegen hinter Aufklappern, ob Soalex läuft, zeigt ein kleiner Chip oben. Der Screen ist dadurch nur noch rund zwei Bildschirmhöhen lang.
- **Dynamischer Stromtarif.** Unter Einstellungen → Verhalten → Stromkosten kannst du statt eines festen Bezugspreises jetzt eine Preis-Entity wählen (z. B. Tibber oder aWATTar, auch mit Tageskurve). Soalex zeigt dir direkt eine Vorschau des erkannten Preises.
- **Lade-Berater (nur Anzeige).** Mit dynamischem Tarif sagt dir eine Karte im Live-Screen, ob sich Laden aus dem Netz vor der Nacht lohnt und in welchem Zeitfenster der Strom am günstigsten ist. Der Berater steuert bewusst nichts — er zeigt nur, was er tun würde.
- **Feedback-Karte.** Nach 14 Tagen Betrieb fragt dich der Live-Screen einmal kurz, wie es mit Soalex läuft. Die Antwort bleibt lokal auf deinem System und kommt nur mit, wenn du einen Diagnose-Export schickst. „Später" blendet die Karte für 30 Tage aus.

### Behoben

- **Akku startete morgens nicht („SoC-Fehler"), bis zum Neustart.** Blieb der Ladestand über Nacht unverändert und endete morgens eine kurze Ladung, bevor der Akku einen neuen Ladestand meldete, hielt Soalex den korrekten Wert für veraltet und wartete bis zum nächsten Neustart. Soalex zählt jetzt nur noch die Zeit, in der der Akku tatsächlich geladen oder entladen wurde — ein ruhender Akku, dessen Ladestand sich nicht bewegt, gilt nie mehr als „Ladestand fehlt". Der Fix aus 0.1.181 hatte genau hier noch eine Lücke.
- **Akku lud nach einem Stopp weiter aus dem Netz.** Kamen zwei Befehle in derselben Sekunde (z. B. eine Nachregelung und der Stopp des Entlade-Zeitfensters), merkte sich Soalex den falschen Stand: der Akku lud weiter, Soalex glaubte 0 W und schickte nichts mehr nach — im Feld bis zu anderthalb Stunden. Soalex gibt jetzt keinen neuen Befehl, solange der vorige noch unterwegs ist, und wiederholt den Stopp danach zuverlässig.
- **Falsches „Akku im Eigenmodus" am Leistungslimit.** Ein Akku, der an seiner Leistungsgrenze läuft (etwa 850 W, wenn 2500 W befohlen sind), wurde als fremdgesteuert gelesen und entsprechend gemeldet. Jetzt erkennt Soalex die Sättigung als das, was sie ist.
- **Die Meldung „Akku liefert nicht" verschwand von selbst.** Stand ein Akku stundenlang still, obwohl er liefern sollte, erkannte Soalex das zwar, hob die Meldung aber selbst wieder auf, sobald es dem Akku keinen Befehl mehr gab — sie war auf keiner Fläche sichtbar. Jetzt bleibt sie bestehen.
- **Akku-Leistungssensor wurde bei manchen Setups nie aktualisiert.** War der gewählte Leistungssensor ein anderer als der Bestätigungs-Sensor (häufig bei Zendure mit selbstgebautem Template-Sensor), abonnierte Soalex ihn nicht: sein Wert fror beim Start ein, der Wirkungs-Check und die Reaktionszeit-Messung liefen blind. Behoben.
- **Geräte mit Watchdog (z. B. Victron MultiPlus-II ESS):** „Befehl auffrischen" (Einstellungen → Verhalten → Akku → Profi-Einstellungen) lässt sich jetzt bis auf 5 s herunter einstellen, vorher war das Minimum 30 s. Geräte, die einen Sollwert verwerfen, wenn er nicht nach ~10 s erneuert wird, laden damit wieder zuverlässig. Der Auffrisch-Befehl geht dabei nie schneller raus als die eingestellte Pause zwischen Anpassungen.
- **„Heute gesteuert" zählte zu wenig.** Bei mehreren Akkus bis zu 40 % zu wenig, bei einem Akku rund 30 %. Der Zähler rechnet jetzt pro Akku und mit dem Sollwert, der im jeweiligen Zeitraum wirklich aktiv war. Die Euro-Zahl bewertet nur noch **entladene** Energie — nur sie ersetzt Netzbezug. Ein reiner Lade-Tag zeigt deshalb viele kWh, aber kaum Euro; das Geld entsteht beim Entladen.
- **SolakonONE: Freigabe-Schalter.** „Modus überschreiben" wird nicht mehr als Freigabe-Schalter vorgeschlagen (er ist ein konkurrierender Steuerkanal, keine Freigabe), und ein bewusst leer gelassener Freigabe-Schalter bleibt beim erneuten Öffnen der Einrichtung leer, statt still wieder befüllt zu werden.
- **Energie-Protokoll bei mehreren Akkus.** Ein nachts abgeschalteter PV-Wechselrichter setzte im internen Energie-Protokoll die Akku-Energie der ganzen Anlage auf null. Behoben — betrifft nur die Aufzeichnung, nicht die Regelung.

### Verbessert

- **Welcome-Karte** zeigt ohne ausreichende Daten keine „Genauigkeit: 0 %" mehr.
- **Pause-Bestätigung** schließt sich nicht mehr nach 5 Sekunden von selbst.
- **Fehler-Ratgeber** im Diagnose-Tab ohne interne Bug-Nummern, mit Verweisen auf Schalter, die es wirklich gibt.
- **Einrichtung:** Wechselst du beim Hinzufügen eines Akkus das Gerät, schlägt der Assistent auch Ladestand- und Leistungssensor neu vor — vorher blieb der Sensor des zuerst gewählten Geräts stehen.
- **Einstellungen:** Fehlermeldungen erscheinen als lesbarer Satz statt als roher Server-Text; bei „Befehl auffrischen" werden ungültige Werte schon beim Tippen abgefangen.
- **Größere Tippflächen auf dem Handy:** Zahlenfelder und „Zurücksetzen" in Verhalten, Filter im Diagnose-Tab.
- Aufräumarbeiten im Regler (Reste des früheren PI-Reglers entfernt) — ohne Verhaltensänderung.

## 0.1.183 — 2026-09-05

- fix(controller): BUG-0089 — „Heute gesteuert" zählte je nach Setup 30–40 % zu wenig
- docs(5.25): Verifikation am lebenden Objekt + UI-Test-Skript
- fix(controller): BUG-0088 — gesättigte Hardware ist kein Gegensteuern
- perf(replay): Ship-Gate-Lauf von ~4 h auf 32 min — Connection-Pool + Prozess-Parallelität
- docs(planning): Strategie Überschusssteuerung Verbraucher (2026-08-28)
- docs(lizenz): Amendment 2026-08-29 — Ablefy + Offline-JWT + Update-Jahr (Architektur/Epics/CLAUDE.md + 6 Epic-7-Stories)
- feat(5.25): Live-Screen „Drei Register" — Null-Linie, Halte-Stunden, Entkernung (+ Review-Fixes)
- refactor(controller): PI-Totholz Code-Phase — _pi_compute/_resolve_pi_tuning/_pi_integration_dt_s raus
- docs(claude): Stolpersteine aufräumen — tote Subsysteme kollabiert, Forensik in Story-Docs
- docs(10.11): AC-10-Korrektur — Negativ-Slots waren Zendure-Vorzeichen-Defekt, nicht die Decision-2-Lücke
- fix(ui+advisor): UI-Feldtest 0.1.182.107 — Berater-Zeiten in UTC (P1) + 4 Folgebefunde
- fix(controller+ui): BUG-0082 — Heartbeat-Boden 30→5 s für Watchdog-Hardware
- fix(review+ui): 5 Review-Findings am Freigabe-Schalter + P1/P2/P3 aus dem UI-Testlauf
- chore(worktree): offene Arbeit der Parallel-Session mitcommitten
- fix(controller): BUG-0086 — Soalex löscht seinen eigenen Alarm nicht mehr
- fix(diagnostics): ERROR_ADVICE-Einträge für die 11.1/11.3-Log-Keys
- docs(10.11): Story-Abschluss — E2 durchgeführt + AC-10-Feld-Verifikation dokumentiert
- feat(11.3): Lade-Berater read-only — pure Wertfunktion + Live-Karte, null Aktorik
- feat(tariff): Story 11.1 — Preis-Provider als Live-Naht + Entity-Picker (dynamischer Tarif)
- fix(wizard): BUG-0085 — Solakon "Modus überschreiben" nie als Freigabe vorschlagen
- fix(wizard): BUG-0085 — geleerter Freigabe-Schalter überlebt das Edit-Öffnen
